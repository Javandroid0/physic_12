const questionsData = [
    ...
    {
        id: 'supp-textbook-1',
        type: 'supplementary-textbook',
        title: 'پایستگی انرژی مکانیکی در نوسانگر هماهنگ ساده',
        content: 'در یک سامانهٔ جرم-فنر که روی سطح افقی بدون اصطکاک نوسان می‌کند، انرژی مکانیکی پایسته است. انرژی مکانیکی (E) برابر با مجموع انرژی جنبشی (K) و انرژی پتانسیل (U) است: $$E = K + U$$. این انرژی به طور پیوسته بین انرژی جنبشی و پتانسیل تبدیل می‌شود. در نقاط بازگشتی ($$x = \\pm A$$)، انرژی جنبشی صفر و انرژی پتانسیل بیشینه است. در نقطه تعادل ($$x = 0$$)، انرژی پتانسیل صفر و انرژی جنبشی بیشینه است. انرژی مکانیکی کل نوسانگر از رابطه $$E = \\frac{1}{2}kA^2$$ به دست می‌آید و با مربع دامنه (A) و مربع بسامد (f) متناسب است: $$E = 2\\pi^2mA^2f^2$$.'
    },
    {
        id: 'supp-teacher-guide-1',
        type: 'supplementary-teacher-guide',
        title: 'نکات آموزشی از راهنمای معلم',
        content: 'هنگام تدریس مفهوم انرژی در نوسانگر، تاکید بر این نکته ضروری است که پایستگی انرژی مکانیکی تنها در غیاب نیروهای اتلافی مانند اصطکاک برقرار است. برای درک بهتر، می‌توان از نمودارهای تبدیل انرژی جنبشی به پتانسیل و بالعکس استفاده کرد. همچنین، بررسی این موضوع که چگونه تغییر دامنه یا بسامد بر انرژی کل سیستم تاثیر می‌گذارد، به تعمیق یادگیری دانش‌آموزان کمک می‌کند. به عنوان مثال، از دانش‌آموزان بخواهید توضیح دهند که چرا یک تاب با دامنه بزرگ‌تر، انرژی بیشتری دارد.'
    },
    {
        id: 'supp-halliday-1',
        type: 'supplementary-halliday',
        title: 'نگاهی عمیق‌تر از فیزیک هالیدی',
        content: 'در کتاب مبانی فیزیک هالیدی، حرکت هماهنگ ساده به عنوان یک حالت خاص از حرکت نوسانی بررسی می‌شود که در آن نیروی بازگرداننده متناسب با جابه‌جایی است ($$F = -kx$$). انرژی در چنین سیستمی نه تنها به صورت پایسته باقی می‌ماند، بلکه می‌توان با استفاده از نمودار انرژی پتانسیل، نقاط بازگشتی و ناحیه حرکت مجاز نوسانگر را تعیین کرد. در تحلیل‌های پیشرفته‌تر، مفهوم "فضای فاز" (نمودار سرعت بر حسب مکان) برای نمایش وضعیت انرژی سیستم در هر لحظه به کار می‌رود که در آن، مسیر حرکت یک بیضی است که نشان‌دهنده پایستگی انرژی است.'
    }
];
